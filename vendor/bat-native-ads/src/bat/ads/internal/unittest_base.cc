...
void UnitTestBase::SetUpForTesting(
  ...
  end_to_end_testing_ = end_to_end_testing;
...
void UnitTestBase::InitializeAds() {
  CHECK(end_to_end_testing_) << "|InitializeAds| should only be called if "
      "|SetUpForTesting| was initialized with end to end testing";
